...
Last updated 2026-09-07. What is still to do. When something ships it leaves
...
| Pushed | yes, both repos. `ui/index.html` gained a source link only; no generated region changed (`render.py --check` passes) |
| Remote | `SMcode-source/uk-home-insurance-market-pricing` (public since 2026-09-07; `data/` has never been committed) |
| Public page | `SMcode-source/home-insurance-price-accuracy` at `7319ce9` (links back to this repository since 2026-09-07) → smcode-source.github.io/home-insurance-price-accuracy/. No local clone survives; `gh repo clone` it when needed |
